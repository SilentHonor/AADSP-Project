...
Pre pokretanja programa, potrebno je kao argumente komandne linije specificirati ulaznu i izlaznu datoteku, kao i sve parametre koji su navedeni u prethodno pomenutom pdf dokumentu "zadatak02", redom.
...
The folder "HAOS_sim" contains implemetation of the previously mentioned processing of audio streams, for the simulation of HAOS "Home Audio Operating System"

Before starting the programs, it is necessary to use the command line arguments to specify input and output file, as well as all the parameters that are given in the previously mentioned pdf document "zadatak02", in that order.
